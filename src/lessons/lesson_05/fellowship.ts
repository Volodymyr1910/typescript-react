...
//? пример типизации массива обьектов - начинаем с типизации одного елемента этого массива

interface IHero {

  id:number, name: string, age:number,isDark:boolean, weapons:string[], image:string
}
...
export const fellowshipArray:IHero[] = [
    {
        id: 1,
        name: "Gendalf",
        age: 2000,
...
export const colorArray: string[]= ["red", "green", "blue"]
